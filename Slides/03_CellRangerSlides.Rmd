...
knitr::include_graphics('Images/10x_cell_isolation.png')
```

Image from https://wp.unil.ch/gtf/single-cell-experiments-10x/
...
* **10x barcode (BC)** -  identifies the droplet in the library
* **UMI (Unique Molecular Identifier)** - identifies the transcript molecule within a cell and gene
* **insert** - the transcript molecule

```{r echo=FALSE, out.width='80%', fig.align='center'}
knitr::include_graphics('Images/3_prime_gene_exp_lib_structure.png')
```

* TruSeq Read 1: Read 1 primer
* TruSeq Read 2: Read 2 primer
* P5 and P7 are short DNA adapter sequences that allow the library to bind to the Illumina flow cell

Image from [10x Genomics](https://kb.10xgenomics.com/s/article/360000939852-What-is-the-difference-between-Single-Cell-3-and-5-Gene-Expression-libraries)
